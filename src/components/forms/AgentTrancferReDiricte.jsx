...
export default function AgentTrancferReDiricte({ fetchData, userIdPoint, userId, close, amountValue, num, method, note }) {
    ...
    const handleSubmitReject= async (e) => {
        ...
        await axios.request(
            {
                url: `${baseUrl}agent/payment-redirect/${userId}`,
                method: "post",
                data: {
                    accept: 0,
                },
